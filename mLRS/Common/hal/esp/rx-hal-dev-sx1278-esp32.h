...
// #define SPI_SELECT_PRE_DELAY              delay_us(1)
// #define SPI_SELECT_POST_DELAY             delay_us(1)
// #define SPI_DESELECT_PRE_DELAY            delay_us(1)
// #define SPI_DESELECT_POST_DELAY           delay_us(1)
#define SX_RESET                  26
#define SX_DIO0                   37
//#define SX_BUSY                   36
...
void sx_init_gpio(void)
{
    ...
    pinMode(SX_DIO0, INPUT_PULLDOWN);
} 
